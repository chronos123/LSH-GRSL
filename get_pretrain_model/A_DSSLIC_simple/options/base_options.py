...
class BaseOptions():
    ...
    def initialize(self):            
        ...
        self.parser.add_argument('--name', type=str, default='Cityscapes_model', help='name of the experiment. It decides where to store samples and models')        
